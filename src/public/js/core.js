        ...
        if (config.type == 'overlay') {
            ...
            switch (config.position) {
                ...
                case 'bottom-right':
                    ...
                    break;
                case 'default':
                    oPopup.css({'top': vnTRUST.get_top_page() + 92, 'left': (pageWidth - oPopup.width()) / 2});
                    break;
            }// end of else;
        }
...
vnTRUST.goTopStart = function () {
    jQuery('body').append('<a href="javascript:void(0)" onclick="jQuery(\'html,body\').animate({scrollTop: 0},1000);" dnot class="go_top" style="display:none"></a>');
...
vnTRUST.show_popupBanner = function (times) {
    var mydata = "mod="+MOD_NAME+"&lang=vn";
    $.ajax({
        async: true,
        dataType: 'json',
